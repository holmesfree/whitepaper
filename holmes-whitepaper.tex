...
Free Mint Amount & 1,000 HOLMES per address \\
...
The core mechanic of HOLMES is the free mint:

\begin{itemize}[leftmargin=*]
    \item Every wallet address can mint 1,000 HOLMES tokens for free
    \item You only pay gas fees (very low on Base)
...
\textbf{Why free mint?} Because this movement is about participation, not investment. We want people who believe in second chances, not speculators looking for the next memecoin to flip.
