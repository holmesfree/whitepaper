...
Free Mint (Public) & 90\% & 900,000,000 \\
Initial Liquidity & 10\% & 100,000,000 \\ \bottomrule
...
The core mechanic of HOLMES is simple and fair:

\begin{itemize}[leftmargin=*]
    \item Every wallet address can mint 1,000 HOLMES tokens for \textbf{free} (just pay gas)
    \item One mint per address---because everyone deserves exactly one second chance
    \item No presale, no VCs, no insider allocation
    \item 90\% of supply available through free mint
    \item 10\% seeded into Uniswap liquidity pool
\end{itemize}

\textbf{Why this model?} Because this movement is about participation, not speculation. Everyone gets equal access to the same amount of tokens. The only cost is the gas fee to execute the transaction on Base (typically less than \$0.01).
...
GitHub: \url{https://github.com/holmesfree}
